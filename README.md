...
| [9](https://leetcode.com/problems/palindrome-number/) | [Palindrome Number](https://github.com/lowspace/leetcode/blob/main/code/9.%20Palindrome%20Number.ipynb) |1. reverse(int) string = int string O(n) <br> 2. int -> string, and compare the begining and the end O(n/2) <br> 3. split the int in half, and compare O(n/2)|`ambguity` <br>`overlapped condition` |